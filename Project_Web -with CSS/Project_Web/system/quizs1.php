...
<html lang="en">
  ...
  <body>
    ...
    <h1 id="main-wrapper">Quiz#1:Evaluating absolute values</h1>
    <form name="form" id="questions" action="quiz11.php" method="post" >
      ...
      <h3 style="color:green; font-weight: bold;" >b. x=-2 and x=7</h3>
      ...
      <h3 style="color:green; font-weight: bold;" >b. t= -19/3 ,t=7</h3>
      ...
      <h3 style="color:green; font-weight: bold;" >b. y=-7/5 and y=9/5</h3>
      ...
      <h3 style="color:green; font-weight: bold;" >b. x=3/10</h3>
