...
<html lang="en">
  ...
  <body>
    ...
    <form name="form" id="questions" action="quizz22.php" method="post" >
      ...
      <h3 style="color:green; font-weight: bold;" >b. x=-27/7</h3>
      ...
      <h3 style="color:green; font-weight: bold;" >b. x=2</h3>
      ...
      <h3 style="color:green; font-weight: bold;" >b. w=64/5</h3>
      ...
      <h3 style="color:green; font-weight: bold;" >b. z=-9/11</h3>
