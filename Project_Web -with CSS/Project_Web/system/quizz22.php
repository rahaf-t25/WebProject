...
$sql = "UPDATE user_registration SET Q2 = '$count', total = '$total', next_lesson = '3' WHERE username = '$username'";
  ...
  <body>
    <form>
      ...
      <div class="child2">
        ...
        <a class="nextlesson" href="lesson3.php"><i class="fas fa-arrow-right"> Move To The Next Lesson</i></a>
      </div>
