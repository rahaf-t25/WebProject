...
<br>
    ...
    <a href="lesson1.php"><input class="lessons" type="button" value="lesson one" id="lesson1_btn"></a>
    <a href="lesson2.php"><input class="lessons" type="button" value="lesson two" id="lesson2_btn"></a>
    <a href="lesson3.php"><input class="lessons" type="button" value="lesson three" id="lesson3_btn"></a>
    <br><br>
